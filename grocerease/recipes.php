...
/* === Enhanced Add Recipe Card Design === */
#addView {
  display: flex;
  justify-content: center;
  align-items: center;
...
/* Form styling to match card design */
#addRecipeForm label {
  font-weight: 700;
  color: #2e7d32;
  display: block;
...
#addRecipeForm input[type="text"]:focus,
...
/* File input styling to match dropdown */
...
#addRecipeForm input[type="file"]:hover {
  border-color: #81c784;
}

#addRecipeForm input[type="file"]::file-selector-button {
...
#addRecipeForm input[type="file"]::file-selector-button:hover {
...
/* Button row */
#addRecipeForm > div[style*="text-align:right"] {
  display: flex;
